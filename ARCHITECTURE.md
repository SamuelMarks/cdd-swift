...
graph TD
    ...
    subgraph Frontend [Parsers]
        ...
        B[Swift Models / Source]:::endpoint --> P2(Swift Parser):::frontend
    ...
    subgraph Backend [Emitters]
        ...
        E2(Swift Emitter):::backend --> Y[Swift Models / Structs]:::endpoint
...
Because of the IR-centric design, adding support for a new `Swift` framework (e.g., a new Client library, Web framework, or ORM) requires minimal effort:
